...
import { StyledLoadingComponent, StyledSVG } from './Loading.styled';

export default function Loading({isShowLoading = false}) {
    return (
     <StyledLoadingComponent isShowLoading={isShowLoading}>
            <StyledSVG xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
